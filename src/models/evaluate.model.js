var readEvaluate      = "SELECT distinct a.*, b.memberName FROM evaluate a, member b, touristAttraction c where a.memberid = b.memberid and a.tourid = c.tourid and a.tourid= $1";
...
module.exports = {
    readEvaluate, insertEvaluate, updateEvaluate, deleteEvaluate
}