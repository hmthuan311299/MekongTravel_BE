var readComment      = "SELECT distinct a.*, b.memberName, b.memberavatar FROM comment a, member b, touristAttraction c where a.memberid = b.memberid and a.tourid = c.tourid and a.tourid= $1 order by commentid desc";
