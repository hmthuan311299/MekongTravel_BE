...
var findMemberByName    = "SELECT memberid, memberemail, membername, memberAvatar, memberaddress, membergender, memberdesc, memberYearofBirth, memberphone  FROM member WHERE memberName iLIKE $1 or first_name iLIKE $2"
